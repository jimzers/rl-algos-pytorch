...
class DDPGAgent:
    ...
    DDPG Agent
    """
    def __init__(self, env, batch_size=64, hidden_size=400, tau=0.95, gamma=0.99, actor_lr=0.01, critic_lr=0.01):
        self.env = env
...
for i in range(epochs):
    # print('epoch run')
    learn_resz = agent.train()
    if learn_resz is not None:
        actor_lossz, critic_lossz, rewardz, target_rewardz, critic_valz, critic_val_newz, eps_scorez, tau_valz = learn_resz
        # print(sum(r_arr))
